# Generated by Django 4.0.5 on 2022-12-02 20:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='plan_category_onlide_idea_category', to='tbcore.category')),
                ('idea', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='plan_category_onlide_idea_i', to='tbcore.onlineidea')),
